...
class DataManager:
    ...
    def get_batch(self):
        data = []
        # Safety limit to prevent infinite loops if dataset is empty or all items are filtered
        ...
        while len(data) < self.batch_size:
            ...
            if attempts > max_attempts:
                raise RuntimeError(f"Unable to fill batch after {max_attempts} attempts. Dataset might be empty or all items are filtered out.")
